...
The default Brewdis app server configuration is stored in https://github.com/Redislabs-Solution-Architects/brewdis/tree/master/brewdis-api/src/main/resources[`brewdis-api/src/main/resources/application.properties`]
